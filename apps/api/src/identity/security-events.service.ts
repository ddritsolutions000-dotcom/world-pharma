...
export type SecurityEventType =
  ...
  | 'LAB_PARTNER_REVIEW'
  | 'HEALTH_PACKAGE_MUTATED'
  | 'CARE_PLAN_CATALOG_MUTATED'
  | 'SERVICEABILITY_ZONE_MUTATED'
  | 'SUBSTITUTE_EDGE_MUTATED'
  ...
  | 'AFFILIATE_LIABILITY_APPROVED'
  | 'AFFILIATE_LIABILITY_REVERSED'
  | 'WISHLIST_ITEM_ADDED'
  ...
  | 'HEALTH_PROFILE_MUTATED'
  | 'HEALTH_SUBJECT_ACCESS'
  | 'APP_AUDIENCE_DENIED'
  | 'PAYMENT_GATEWAY_CONFIG_UPDATED'
  | 'NOTIFICATION_PROVIDER_CONFIG_UPDATED'
  | 'NOTIFICATION_PROVIDER_CONFIG_CREATED'
  | 'NOTIFICATION_ADMIN_SEND'
  | 'NOTIFICATION_OPS_VIEWED'
  | 'IMAGING_LOCATION_UPDATED'
  | 'R14A_GATE_UPDATED'
  | 'COUNTRY_LIFECYCLE_CHANGED'
  | 'COUNTRY_PRODUCTION_ACTIVATED'
  | 'COUNTRY_PRODUCTION_SUSPENDED'
  | 'COUNTRY_ACTIVATION_DRY_RUN'
  | 'REGULATORY_EVIDENCE_VERIFIED'
  | 'REGULATORY_EVIDENCE_REJECTED'
  | 'REGULATORY_EVIDENCE_EXPIRED'
  | 'REGULATORY_EVIDENCE_UPDATED'
  | 'PHARMACY_LICENCE_SUBMITTED'
  | 'PHARMACY_LICENCE_VERIFIED'
  | 'PHARMACY_LICENCE_REJECTED'
  | 'PHARMACY_LICENCE_EXPIRED'
  | 'PHARMACY_LICENCE_REPLACED'
  | 'PARTNER_COMMERCIAL_APPROVED'
  | 'PARTNER_COMMERCIAL_REVOKED'
  | 'PARTNER_OPS_ACTIVATED'
  | 'PARTNER_OPS_SUSPENDED'
  | 'PARTNER_OPS_REACTIVATED'
